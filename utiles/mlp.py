...
class MLP(torch.nn.Module):
    ...
    def __repr__(self):
        return '{}({}, {}, num_layers={}, batch_norm={}, dropout={}, activation= {})'.format(
            self.__class__.__name__, self.in_channels, self.out_channels,
            self.num_layers, self.batch_norm, self.dropout, self.activation)
    
if __name__ =='__main__':

    model = MLP(16, 32, num_layers=2, batch_norm=True, dropout=0.5, activation= 'RelU')
    print(model)
